...
const Registration = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        // Build initial "about" answers and selected question list
        const aboutFields = {};
        const selected = [];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Cloudinary upload if a new file is selected
      ...
      <div className="container">
        <form onSubmit={handleSubmit} encType="multipart/form-data">
          ...
          {[
            ...
            { label: "Job", name: "job" },
            { label: "Social Media Handle", name: "socialMediaHandle" }
            ...
            <div className="text" key={name}>
              <div className="form-check mb-2">
                <input
                  ...
                  disabled={!selectedQuestions.includes(name) && selectedQuestions.length >= 5}
                  onChange={() => {
